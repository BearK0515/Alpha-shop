import "../Style/Step1.modules.scss"
      ...
      <form className="address col col-12" data-phase="address">
        ...
        <section className="form-body col col-12">
          <div className="input-container col col-12">
            <div className="input-group appellation input-w-lg-2 input-w-sm-s1">
          ...
          <div className="input-container col col-12">
            <div className="input-group number input-w-lg-3 input-w-sm-full">
              <div className="input-label">電話</div>
              <input type="tel" placeholder="請輸入行動電話" />
            </div>
            <div className="input-group email input-w-lg-3 input-w-sm-full">
