import "../Style/Step2.modules.scss"

export default function Step2 () {
  return (
    <form class="shipping d-none col col-12" data-phase="shipping">
      <h3 class="form-title">運送方式</h3>
      <section class="form-body Shipping col col-12">
        <label class="radio-group checked col col-12" data-price="0">
          <input id="shipping-standard" type="radio" name="shipping"  checked/>
          <div class="radio-info">
            <div class="shipping-container col col-12">
